...
private:
    ...
    std::priority_queue<std::shared_ptr<Order>> bids_;   // Buy orders (highest price first)
    std::priority_queue<std::shared_ptr<Order>> asks_;   // Sell orders (lowest price first)

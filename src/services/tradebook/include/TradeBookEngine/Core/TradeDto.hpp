    ...
    namespace Core
    {
        namespace Models
        {
            ...
            struct TradeDto
            {
                ...
                TradeDto()
                    : AssetClass(Enums::AssetClass::Equity), Notional(0.0), Side(Enums::TradeSide::Buy), TradeDate(std::chrono::system_clock::now()), CreatedAt(std::chrono::system_clock::now()), Status(Enums::TradeStatus::Pending)
                {
                }
            };
